        ...
        while True:
            try:
                ...
                if command == 'help':
                    ...
                    print("\nAvailable commands:")
                    print("  add, subtract, multiply, divide, power, root, modulus, integer_division, percentage_calculation, absolute_difference - Perform calculations")
                ...
                if command in ['add', 'subtract', 'multiply', 'divide', 'power', 'root', 'modulus', 'integer_division', 'percentage_calculation', 'absolute_difference']:
